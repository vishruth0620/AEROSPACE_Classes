...
# -*- coding: utf-8 -*-
"""
Created on Sun Oct 18 20:06:51 2020
...
if(0 <= t <= 260 and 5 <= p <= 10) :#determine whether the input temperature is within the valid range
    vi_5 = lin_int(v_5,t)#Linear Interpolate the volume for 5 MPa
    vi_10 = lin_int(v_10,t)#Linear Interpolate the volume for 10 MPa
    ui_5 = lin_int(u_5,t)#Linear Interpolate the internal energy for 5 MPa
    ui_10 = lin_int(u_10,t)#Linear Interpolate the internal energy for 10 MPa
    hi_5 = lin_int(h_5,t)#Linear Interpolate the enthalpy for 5 MPa
    hi_10 = lin_int(h_10,t)#Linear Interpolate the enthalpy for 10 MPa
    si_5 = lin_int(s_5,t)#Linear Interpolate the entropy for 5 MPa
    si_10 = lin_int(s_10,t)#Linear Interpolate the entropy for 10 MPa
